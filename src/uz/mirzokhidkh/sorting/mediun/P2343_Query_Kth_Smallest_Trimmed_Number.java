...
public class P2343_Query_Kth_Smallest_Trimmed_Number {
    ...
    public int[] smallestTrimmedNumbers(String[] nums, int[][] queries) {
        ...
        while(digit <= maxValLen && finishedTask < queries.length) {
            sorted = countingSort(sorted, maxValLen, digit);
    ...
    private String[] countingSort(String[] nums, int maxValLen, int digit) {
